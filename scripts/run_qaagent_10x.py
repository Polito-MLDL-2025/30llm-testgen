    ...
    while True:
        ...
        while True:
            ...
            if not process.is_alive():
                ...
                if exit_code == 0:
                    return
                raise RuntimeError(f"QAagent exited with code {exit_code}")
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        description="Run QAagent sequentially and aggregate summary stats into a CSV."
    )
    ...
    if args.predefine_name:
        ...
        base_name = f"{timestamp}_qaagen_{dataset_name}_{model_name}"
